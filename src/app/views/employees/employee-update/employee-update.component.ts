...
@Component({
    ...
    standalone: true,
    imports: [ViewBaseComponent, ViewHeaderComponent, CardComponent, FormsModule, ReactiveFormsModule, NonFieldErrorsComponent, FormInputComponent, FormDatepickerComponent, BtnBackComponent, BtnLoadingComponent, SpinnerComponent]
})
