...
@Component({
    ...
    standalone: true,
    imports: [ViewBaseComponent, ViewHeaderComponent, DotSuccessComponent, DotDangerComponent, EmployeeDetailsComponent, CardComponent, TabsModule, EmployeeDepartmentsComponent, EmployeeTasksComponent, EmployeeTimeControlComponent]
})
